...
name as study_title, -- is study title the full study name? 
...
from {{ ref('stable_study')}} s-- think about how this would be adjusted to account for all stable_study tables in KF
